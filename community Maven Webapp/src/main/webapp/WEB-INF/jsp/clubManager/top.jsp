...
<body style="background:url(${pageContext.request.contextPath}/static/images/topbg.gif) repeat-x;">
    <div class="topleft">
    <a href="/community/clubManager/main" target="_parent"><img src="${pageContext.request.contextPath}/static/images/logo.png" title="系统首页" /></a>
    </div>
    ...
    <div class="user">
    <span style="width:55px">${user.userName }</span>
    </div>    
