...
<style type="text/css">
  ...
  <body>
    ...
    <form  id="form" action="/community/admin/doUpdateAdminPsw" method="post" >
    ...
    <li><label>新密码：</label><input id="adminPassword" name="adminPassword" type="password" class="dfinput" /></li>
    <li><label>确认新密码：</label><input id="adminPassword1" name="adminPassword1" type="password" class="dfinput" /></li>
